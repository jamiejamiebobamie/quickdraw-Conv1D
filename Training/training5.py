...
print(len(desired_labels) == num_classes, num_classes, label_to_i)
...
history = model.fit(X_train, y_train, callbacks=EarlyStopping(monitor='val_loss', patience=1), batch_size=batch_size, epochs=epochs, verbose=1, validation_data=(X_test[half:], y_test[half:]))
